...
L["HIGH_RANK_REAGENTS_DESC"] = "Reagents cell will not show background colour if you only have reagents above rank 1"
...
L["PROFIT_LOSS_CURRENCY_DROPDOWN_DESC"] = "Set custom values for currencies here"
...
L["BLOCK_MOVE_CREATE_TO_CURSOR_NAME"] = "(Unless Best Quality selected)"
L["BLOCK_MOVE_CREATE_TO_CURSOR_DESC"] = "Exception: don't move Create button if Best Quality Reagents is selected"
L["START_CRAFT_BUTTON_NAME"] = "Apply above settings to all known characters on this account"